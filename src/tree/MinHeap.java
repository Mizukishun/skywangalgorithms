...
public class MinHeap {
	...
	protected MinHeap(int[] a){
		...
		//从(size/2-1)至0，逐次遍历，遍历之后，得到的数组实际上是一个最小堆
	 ...
	 * 最小堆的向下调整算法
	 * 
	 * 注：数组实现的堆中，第N个节点的左孩子的索引值为(2N+1),右孩子的索引是(2N+2)
	 * 
